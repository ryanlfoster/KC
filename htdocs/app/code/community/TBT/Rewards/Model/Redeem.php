...
class TBT_Rewards_Model_Redeem extends Mage_Core_Model_Abstract {
	...
	public function refactorRedemption(&$persistentItem, $doSave = true) {
		...
		if ($item instanceof Mage_Sales_Model_Quote_Item_Abstract) {
    		...
    		$item->setId($persistentItem->getId())
    			->setQuote($persistentItem->getQuote())
    			->setParentItem($persistentItem->getParentItem());
    		
    		$children = $persistentItem->getChildren();
    		...
    		$messages = $persistentItem->getMessage(false);
