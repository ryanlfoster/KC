...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tab_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
        ...
        // Can't left join the points index b/c it can have multiple records per customer ID, so
        // if it's joined, then the resulting collection can have multiple items per customer ID,
        // which will result in "Item (Mage_Customer_Model_Customer) with the same id "18" already exist"
