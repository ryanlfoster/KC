...
include_once('app'.DS.'code'.DS.'community'.DS.'TBT'.DS.'Rewards'.DS.'controllers'.DS.'Admin'.DS.'AbstractController.php');
class TBT_Rewards_Manage_Promo_QuoteController extends TBT_Rewards_Admin_AbstractController {
	...
	public function saveAction() {
		if ($data = $this->getRequest ()->getPost ()) {
			...
			if (isset ( $data ['points_discount_action'] ) && $data ['points_discount_action'] == 'by_percent' && isset ( $data ['points_discount_amount'] )) {
				$data ['points_discount_amount'] = min ( 100, $data ['points_discount_amount'] );
			}
