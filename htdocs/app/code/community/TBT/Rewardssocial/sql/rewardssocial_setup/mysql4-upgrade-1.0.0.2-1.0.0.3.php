...
if ($safeMode || !$canUse['file_exists'] || !$canUse['copy']) {
    ...
    $this->createNotice("Could not update TBT_Rewardssocial.csv",
        "System commands have been disabled on your system, so we could not update Sweet Tooth's " .
            ...
            "<a href='http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_update'>here</a> " .
            "for more information.",
        "http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_update",
        ...
        if (!$isSafeToOverwrite) {
            ...
            $this->createNotice("Could not backup TBT_Rewardssocial.csv ({$locale})",
                "Sweet Tooth does not have write permissions to backup your {$locale}/TBT_Rewardssocial.csv " .
                    ...
                    "<a href='http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_backup'>here</a> " .
                    "for more information.",
                "http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_backup",
                Mage_AdminNotification_Model_Inbox::SEVERITY_MAJOR
            );
            $allOverwritesSuccessful = false;
        } else {
                ...
                if (!$isOverwriteSuccessful) {
                    ...
                    $this->createNotice("Could not overwrite TBT_Rewardssocial.csv ({$locale})",
                        "Sweet Tooth does not have permissions to overwrite your {$locale}/TBT_Rewardssocial.csv " .
                            "file, so we could not update it.  Click " .
                            "<a href='http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_overwrite'>here</a> " .
                            "for more information.",
                        "http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1#Could_not_overwrite",
                        Mage_AdminNotification_Model_Inbox::SEVERITY_MAJOR
                    );
                    $allOverwritesSuccessful = false;
                }
...
if ($allOverwritesSuccessful) {
    $this->createNotice("TBT_Rewardssocial.csv has been replaced",
        ...
        "http://sweettoothrewards.com/wiki/index.php/Rewardssocial_CSV_updated_in_1.6.1",
