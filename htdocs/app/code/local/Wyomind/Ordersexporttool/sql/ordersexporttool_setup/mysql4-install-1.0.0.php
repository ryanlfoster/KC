...
$installer->run('INSERT into `' . $this->getTable('ordersexporttool_profiles') . '` 
...
values (2,\'default\',1,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',0,\'order\',\'<orders>\',\'        <order id="{entity_id order}" no="{increment_id}">
		<customer>
	...
	</order>\',\'</orders>\',\';\',\'\',1,\'[]\',\'complete\',\'0,1\',\'{"days": ["Wednesday", "Thursday"], "hours": ["03:00", "04:00", "05:00", "06:00"]}\',0,null,null,null,0,null)
, (3,\'default\',3,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',1,\'order\',\'{"header":["order#", "customer", "Shipping Address", "Product name", "Product sku", "Product price", "Total price"]}\',\'{"order":["{increment_id}", "{customer_firstname,[strtolower],[ucfirst]} {customer_lastname,[strtoupper]}", "{firstname shipping} {lastname shipping} {middlename shipping}{city shipping} {postcode shipping}{region shipping} {street shipping,[implode]} ", "{name product}", "{sku product}", "{price product,[float],[2]}", "{base_grand_total,[float],[2]}"]}\',\'\',\';\',\'\',0,\'[]\',\'new,processing,complete,closed,canceled,holded\',\'0,1\',\'{"days":[],"hours":[]}\',1,null,null,null,0,\'/\')
, (4,\'consolidated\',3,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',0,\'order\',\'{"header":["order #", "total_weight", "total_cost", "customer firstname", "customer lastname"]}\',\'{"order":["{increment_id}", "{consolided_weight,[float],[2]}", "{consolided_cost,[float],[2]}", "{customer_firstname}", "{customer_lastname}"]}\',\'\',\';\',\'\',0,\'[]\',\'new,processing,complete,closed,canceled,holded,payment_review\',\'0,1\',\'{"days":[],"hours":[]}\',0,null,null,null,0,null)
, (11,\'GoogleTrustedStoresShipment\',2,\'/var/export/\',\'1\',1,NULL,0,null,0,\'Y-m-d\',1,\'order\',\'{"header":["merchant order id", "tracking number", "carrier code", "other carrier name", "ship date"]}\',\'{"order":["{increment_id}", "", "Others", "{shipping_description}", "{created_at shipment,[date],[Y-m-d]}"]}\',\'\',\'	\',\'\',0,\'[{"line": "0", "checked": true, "code": "shipment.entity_id", "condition": "notnull", "value": ""}, {"line": "1", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "2", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "3", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "4", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "5", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "6", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "7", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "8", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "9", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "10", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}]\',\'new,processing,complete,closed,canceled,holded\',\'0,1\',\'{"days": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], "hours": ["00:00"]}\',0,\'\',\'\',\'\',0,\'\')
, (12,\'GoogleTrustedStoreCancellation\',2,\'/var/export/\',\'1\',1,NULL,0,null,1,\'Y-m-d\',1,\'order\',\'{"header":["merchant order id", "reason"]}\',\'{"order":["{increment_id}", "{cancelation_type_for_google}"]}\',\'\',\'	\',\'\',0,\'[]\',\'canceled\',\'0,1\',\'{"days": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], "hours": ["00:00"]}\',0,null,null,null,0,null);
...
if (version_compare(Mage::getVersion(), '1.4.0', '<')) {
    $installer->getConnection()->addColumn(
            $installer->getTable('sales_order'), 'export_flag', 'varchar(100) NULL'
    );
    ...
    $installer->getConnection()->addColumn(
            $installer->getTable('sales_flat_order'), 'export_flag', 'varchar(100) NULL'
    );
    $installer->getConnection()->addColumn(
            $installer->getTable('sales/order_grid'), 'export_flag', 'varchar(100) NULL'
    );
}
