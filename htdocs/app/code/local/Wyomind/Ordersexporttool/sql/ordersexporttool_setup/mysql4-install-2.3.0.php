...
, (4,\'consolidated\',3,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',0,\'order\',\'{"header":["order #", "total_weight", "total_cost", "customer firstname", "customer lastname"]}\',\'{"order":["{increment_id}", "{consolided_weight,[float],[2]}", "{consolided_cost,[float],[2]}", "{customer_firstname}", "{customer_lastname}"]}\',\'\',\';\',\'\',0,\'[]\',\'complete,pending,processing\',\'0,1\',\'{"days":[],"hours":[]}\',0,null,null,null,0,null)
