...
, (3,\'default\',3,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',1,\'order\',\'{"header":["order#", "customer", "Shipping Address", "Product name", "Product sku", "Product price", "Total price"]}\',\'{"order":["{increment_id}", "{customer_firstname,[strtolower],[ucfirst]} {customer_lastname,[strtoupper]}", "{firstname shipping} {lastname shipping} {middlename shipping}{city shipping} {postcode shipping}{region shipping} {street shipping,[implode]} ", "{name product}", "{sku product}", "{price product,[float],[2]}", "{base_grand_total,[float],[2]}"]}\',\'\',\';\',\'\',0,\'[]\',\'complete\',\'0,1\',\'{"days":[],"hours":[]}\',0,null,null,null,0,\'/\')
, (4,\'consolidated\',3,\'/var/export/\',\'1\',1,NULL,0,null,0,\'\',0,\'order\',\'{"header":["order #", "total_weight", "total_cost", "customer firstname", "customer lastname"]}\',\'{"order":["{increment_id}", "{consolided_weight,[float],[2]}", "{consolided_cost,[float],[2]}", "{customer_firstname}", "{customer_lastname}"]}\',\'\',\';\',\'\',0,\'[]\',\'complete\',\'0,1\',\'{"days":[],"hours":[]}\',0,null,null,null,0,null)
, (11,\'GoogleTrustedStoresShipment\',2,\'/var/export/\',\'1\',1,NULL,0,null,0,\'Y-m-d\',1,\'order\',\'{"header":["merchant order id", "tracking number", "carrier code", "other carrier name", "ship date"]}\',\'{"order":["{increment_id}", "", "Others", "{shipping_description}", "{created_at shipment,[date],[Y-m-d]}"]}\',\'\',\'	\',\'\',0,\'[{"line": "0", "checked": true, "code": "shipment.entity_id", "condition": "notnull", "value": ""}, {"line": "1", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "2", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "3", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "4", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "5", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "6", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "7", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "8", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "9", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}, {"line": "10", "checked": false, "code": "order.adjustment_negative", "condition": "eq", "value": ""}]\',\'complete\',\'0,1\',\'{"days": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], "hours": ["00:00"]}\',0,\'\',\'\',\'\',0,\'\')
