...
class Wyomind_Datafeedmanager_Block_Adminhtml_Configurations_Edit_Tab_Ftp extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('use_sftp', 'select', array(
            'label' => Mage::helper('datafeedmanager')->__('Use SFTP'),
            'name' => 'use_sftp',
            'id' => 'use_sftp',
            'required' => true,
            'values' => array(
        ...
        $fieldset->addField('ftp_dir', 'text', array(
            ...
            'name' => 'ftp_dir',
            'id' => 'ftp_dir',
            'note' => "<a style='margin:10px; display:block;' href='javascript:datafeedmanager.testFtp(\"" . $this->getUrl('*/*/ftp') . "\")'>Test Connection</a>"
        ));
