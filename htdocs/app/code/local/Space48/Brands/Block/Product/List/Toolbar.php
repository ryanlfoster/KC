<?php
class Space48_Brands_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    public function setCollection($collection)
    {
        ...
        if (Mage::registry('brand')) {
            if ($this->getCurrentOrder() == 'space48_position') {
                $this->_collection->getSelect()
                    ->joinLeft(
                        array(
                            'space48_position' => 'space48_attribute_landing_page_products'
                        ),
                        'e.entity_id=space48_position.product_id',
                        array(
                            'space48_position.*'
                        )
                    )
                    ->order('space48_position.position', 'ASC');
            }
        }
